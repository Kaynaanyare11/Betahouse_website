          ...
          <ul className=" font-semibold text-xl text-gray-400 flex gap-5 me-16">
            <Link to={"/"}>
              <li className="nav-item">
                <a
                  className="nav-link hover:border-b-2 border-blue-500"
                  href="/"
                >
                  Home
                </a>
            ...
            <Link to="about" smooth={true} duration={500}>
              <li className="nav-item">
                <a className="nav-link hover:border-b-2 border-blue-500">
                  About
                </a>
              </li>
            </Link>
...
{/*Side Bar*/}
      <div
        className={` ${
          mobile ? "block" : "hidden"
        } w-[100%] relative center top-5 shadow-sm h-[900px] md:hidden`}
      >
